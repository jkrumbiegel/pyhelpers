...
def get_lch_rgb(n_colors, l_min, l_max, c_min, c_max, h_min, h_max):

    L = np.linspace(l_min, l_max, n_colors)
    c = np.linspace(c_min, c_max, n_colors)
    h = np.linspace(h_min, h_max, n_colors)
...
def get_lab_rgb(n_colors, l_min, l_max, a_min, a_max, b_min, b_max):

    L = np.linspace(l_min, l_max, n_colors)
    a = np.linspace(a_min, a_max, n_colors)
    b = np.linspace(b_min, b_max, n_colors)
    ...
    rgb_colors = [
        convert_color(Lab_color, AdobeRGBColor)
